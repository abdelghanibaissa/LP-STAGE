  ...
  <div class="container-fluid">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="demands.jsp"><i class="bi bi-file-earmark-plus"></i>Demands</a>
        </li>
      </ul>
      <a href="">profile</a>
    </div>
...
<div class="container">
<h1>Liste de reclamation</h1>
<button type="button" class="btn btn-primary" id="btn">nouvelle reclamation</button>
...
<label> Nr</label>
<input type="text" id="id_de" name="id_de">
<div class="textline">
